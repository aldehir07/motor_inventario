...
class InventarioService:
    ...
    def registrar_entrada(self, data: RegistrarEntrada):
        ...
        try:
            ...
            logger.success("Entrada registrada correctamente. Producto={}, Stock={}", data.producto_id, inventario.stock_actual)
